...
This project is a [_fastlane_](https://github.com/fastlane/fastlane) plugin. To get started with `fastlane-plugin-hockey_devices`, add it to your project by running:

```bash
fastlane add_plugin hockey_devices
```

## About hockey_devices
